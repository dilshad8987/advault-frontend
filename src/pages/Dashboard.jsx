...
function MetaSVG({ active }) {
  ...
  return (
    <svg width="26" height="12" viewBox="0 0 66 30" fill="none">
      <path d="M4 18C4 13 6.5 8 10 8C12.5 8 14.5 10 17 14L20 19C22 22.5 24 25 26.5 25C29.5 25 31.5 21.5 31.5 16.5C31.5 12 29.5 9 27 8"
        stroke={c1} strokeWidth="3.5" strokeLinecap="round" fill="none"/>
      <path d="M4 16C4 10 6.5 5 11 5C13.5 5 16 7 18.5 11L21.5 16C23.5 19.5 26 22.5 28.5 22.5"
        stroke={c2} strokeWidth="3.5" strokeLinecap="round" fill="none"/>
  ...
  const fetchAds = useCallback(async () => {
    ...
    try {
      if (tab === 'tiktok') {
        ...
        sessionStorage.setItem(key, JSON.stringify(Array.isArray(raw) ? raw : []));
