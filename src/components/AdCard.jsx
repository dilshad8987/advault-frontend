...
export default function AdCard({ ad, platform = 'tiktok' }) {
  ...
  // ── Meta fields ──
  const mtTitle   = (ad.ad_creative_bodies?.[0] || ad.ad_creative_link_titles?.[0] || ad._raw?.page_name || ad.title || 'No Title').slice(0, 120);
  const mtBrand   = ad.page_name || ad._raw?.page_name || ad.bylines || 'Unknown Page';
